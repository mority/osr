// Generated from motis ui/src/lib/map/style.ts (motis 0ee2da9) - do not edit
// by hand. To regenerate: run it through node's
// require('node:module').stripTypeScriptTypes(src, {mode: 'strip'}), delete
// the import lines, turn `export const` into `const`, and append
// `export { getStyle, colors };`. The one import it needs is LEVEL_MIN_ZOOM,
// defined below. The style matches the Shortbread tile schema that MOTIS
// serves at <api>/tiles/{z}/{x}/{y}.mvt.

const LEVEL_MIN_ZOOM = 16; // motis ui/src/lib/constants.ts
...
const getStyle = (
	...
	const hillshadeSources                                = withHillshades
		? {
				hillshadeSource: {
					type: 'raster-dem',
		...
		: {};
	const hillshadeLayers                                = withHillshades
		? [
				{
					id: 'hillshade',
					type: 'hillshade',
